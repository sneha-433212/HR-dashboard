...
//   {/* Department chip with soft blue transparent */}
//   <Chip
//     size="small"
//     label={e.department || "-"}
//     sx={{
//       backgroundColor: "rgba(37, 99, 235, 0.1)", // soft blue
//       color: "#384052ff", // text blue
//       fontWeight: 500,
//     }}
//   />

//   {/* Active chip - soft transparent */}
//   <Chip
//     size="small"
//     label={e.status || "Active"}
//     color={(e.status || "Active") === "Active" ? "success" : "warning"}
//     variant="outlined"
//     sx={{
//       fontWeight: 500,
//       backgroundColor: "rgba(0, 128, 0, 0.08)", // soft green bg for Active
//     }}
//   />

//   {/* Performance chip - soft transparent */}
//   <Chip
//     size="small"
...
//     sx={{
//       fontWeight: 500,
//       backgroundColor: "rgba(100, 77, 77, 0.04)", // soft transparent bg
//     }}
//   />

//   {/* Tenure chip with soft blue transparent */}
//   <Chip
//     size="small"
//     label={`Tenure: ${tenureStr}`}
//     sx={{
//       backgroundColor: "rgba(37, 99, 235, 0.1)", // soft blue
//       color: "#274151ff",
//       fontWeight: 500,
...
export default function EmployeeProfilePage() {
            ...
            <Box>
              ...
              <Stack direction="row" spacing={1} mt={1}>
                ...
                <Chip
                  ...
                  sx={{
                    fontWeight: 500,
                    backgroundColor: "rgba(100, 77, 77, 0.04)",
                  }}
                />
  ...
  {skillChips.map((m, i) => (
    <Chip
      ...
      variant="outlined"
      sx={{
        backgroundColor: "rgba(154, 20, 154, 0.1)", // soft transparent purple
        color: "#3f3f6dff", // purple text
        fontWeight: 500,
    ...
    />
                ...
                {/* RIGHT SIDE: Documents & Achievements */}
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, fontSize: "1.1rem" }}>
                    Document
                  </Typography>
